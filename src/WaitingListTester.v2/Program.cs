...
//				var response = await client.PostAsJsonAsync(baseUrl, course);
                var response = await PostAsJsonAsync(client, baseUrl, course);
				...
				response = await PostAsJsonAsync(client, courseResource + "/students", nonexistingStudent);
				...
				response = await PostAsJsonAsync(client, courseResource + "/students", student1);
				...
				response = await PostAsJsonAsync(client, courseResource + "/students", student2);
				...
				response = await PostAsJsonAsync(client, courseResource + "/students", student3);
				...
				response = await PostAsJsonAsync(client, courseResource + "/students", student4);
				ReportIntermedateResult("7. Add student 4", response.StatusCode == HttpStatusCode.Created);

				// 8. Add a student to a full course:
				response = await PostAsJsonAsync(client, courseResource + "/students", student5);
...
//					ReportResultForRule(6, content.Count == 3, "Should contain 3 students");
					...
					ReportResultForRule(6, list.Count == 3, "Should contain 3 students");
				}
				else
				{
				...
				response = await PostAsJsonAsync(client, courseResource + "/waitinglist", nonexistingStudent);
				ReportResultForRule(0, response.StatusCode == HttpStatusCode.NotFound, "Should return 404");

				// 12. Add an existing person to the waiting list:
				response = await PostAsJsonAsync(client, courseResource + "/waitinglist", student1);
...
//					var content = await response.Content.ReadAsAsync<List<Student>>();
                    var content = await response.Content.ReadAsStringAsync();
                    var list = JsonConvert.DeserializeObject<List<Student>>(content);
					ReportIntermedateResult("13. Get waiting list", response.StatusCode == HttpStatusCode.OK && list.Count == 1);
				}
				else
				{
...
//					var content = await response.Content.ReadAsAsync<List<Student>>();
                    ...
                    var content = JsonConvert.DeserializeObject<List<Student>>(json);
				...
				response = await PostAsJsonAsync(client, courseResource + "/waitinglist", student6);
				...
				response = await PostAsJsonAsync(client, courseResource + "/waitinglist", student2);
				...
				response = await PostAsJsonAsync(client, baseUrl + "9999999/waitinglist", student5);
				ReportResultForRule(9, response.StatusCode == HttpStatusCode.NotFound, "Should return 404");

				response = await PostAsJsonAsync(client, baseUrl + "9999999/students", student5);
				ReportResultForRule(9, response.StatusCode == HttpStatusCode.NotFound, "Should return 404");

            }            
        }

        static async Task<HttpResponseMessage> PostAsJsonAsync(HttpClient client, string baseUrl, object obj)
        {
